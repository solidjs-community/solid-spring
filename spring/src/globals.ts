...
import { type FluidValue, getFluidValue } from './fluids'
import type { OpaqueAnimation } from './FrameLoop'
import {
  Interpolation,
  type InterpolatorArgs,
 ...
 */
export let createStringInterpolator = (config: InterpolatorConfig<string>) => {
  if (!namedColorRegex) {
...
export let colors = _colors as Record<string, number> | null
